...
Choose **Try it with sample data** on the landing page, or open `/demo` (or `/?demo=1`), to load a bundled family-weekend Takeout sample. It contains two photos, Google JSON sidecars, a Motion Photo companion, and one unknown file for review.
